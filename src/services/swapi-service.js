export default class SwapiService {
    ...
    async postRate(stars, idMovie) {
        console.log(stars,idMovie)
        const guestSession = await this.getGuestSessionId();
        console.log(guestSession)
        // const res = await fetch(`${this._apiBase}/3/movie/${idMovie}/rating?api_key=${this._apiKey}&guest_session_id=${guestSession}`, {
        const res = await fetch(`https://api.themoviedb.org/3/movie/635744/rating?api_key=864cd2acdebdfd281550947ea6066439&guest_session_id=313ac9f5b38bf9ac4196e2e82f659c80`, {
            method: 'POST',
            body: {
                value: stars
            }
        ...
        return await res.json().status_message;
    }
