export default class SwapiService {
  ...
  // async getRateMovie(stars, idMovie) {
  //
  //   const result = await fetch(`https://api.themoviedb.org/3/guest_session/${guestSession}/rated/movies?api_key=${this._apiKey}&sort_by=created_at.asc`);
  //   if (!result.ok) {
  //     throw new Error(`Could not fetch , received ${res.status}`)
  //   }
